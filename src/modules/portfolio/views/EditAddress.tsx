...
interface RouteProps {
    route: RouteProp<RootNavigatorParamList, 'EditAddress'>;
}

type DispatchProps = {
    editPortfolio: typeof portfolioActionCreators.editPortfolio;
};

const EditAddressScreen = (props: DispatchProps & RouteProps) => {
    const { t } = useSetting();
    ...
    const handleAddPortfolio = () => {
        ...
        const payload: portfolio.EditPortfolioRequest = {
            id: params.id,
...
export default connect<undefined, DispatchProps>(undefined, {
    editPortfolio: portfolioActionCreators.editPortfolio,
})(EditAddressScreen);
